...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        File orData = new File("C:/Users/matys/Desktop/PROGRAMY_DR/SGP4_Propagacja/dane");
        DataProvidersManager manager = DataContext.getDefault().getDataProvidersManager();
        manager.addProvider(new DirectoryCrawler(orData));

        File f = new File("C:/Users/matys/Desktop/PROGRAMY_DR/SGP4_Propagacja/dane/kat_tle.txt");

        Scanner skan = new Scanner(f);
    String tle_0a=skan.nextLine();
        ...
        while (skan.hasNextLine()) {
            ...
            PrintWriter output2 = new PrintWriter("C:/Users/matys/Desktop/PROGRAMY_DR/SGP4_Propagacja/dane/" + nazwa);
           ...
           // extrapDate = new AbsoluteDate(2022, 3, 29, 22, 31, 33.0, TimeScalesFactory.getUTC());
            ...
            AbsoluteDate finalDate = extrapDate.shiftedBy(60.0 * 60 * 24); //seconds
